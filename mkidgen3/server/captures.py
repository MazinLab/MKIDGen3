...
class CaptureRequest:
    ...
    def __init__(self, n: int, tap: str, feedline_config: FeedlineConfig,
        ...
        self.data_endpoint = file or None
    ...
    @property
    def is_file_endpoint(self):
        return self.data_endpoint is not None and self.data_endpoint.startswith('file://')
    ...
    def establish(self, context: zmq.Context = None):
        ...
        self._status_socket.connect(STATUS_ENDPOINT)
        if self.is_file_endpoint:
        ...
        self._data_socket.connect(self.data_endpoint or DATA_ENDPOINT)
...
class CaptureJob:
    ...
    def submit(self, with_sink=False, with_status=True):
        ...
        if with_sink and not self.request.is_file_endpoint:
            self.datasink.start()
            self.datasink.ready()
